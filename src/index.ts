...
client.on('stageInstanceCreate', async (stageInstance) => {
	...
	await specDubQuestions.send(
		"Reminder: **messages sent in this channel will be visible in the recording!**\n" +
		"Set your server nickname to something you would be comfortable showing up in the recording.\n" +
		"**Profile pictures will not be visible.**"
	)
